...
exports.createSupplierTableIfNotExist = async () => {
  ...
  if (!isTableExist) {
    ...
    var sqlBeforeUpdateTrigger =
      ...
      ` SET action ="update",supplierId=old.supplierId,name=old.name,email=old.email,country=old.country,state=old.state,city=old.city,street=old.street,pinCode=old.pinCode,poBox=old.poBox,contactNo=old.contactNo,supplierDetails=old.supplierDetails,updatedOn= NOW();` +
      "END;";
