...
exports.getCompleteCategoriesDetails= async (req, res, next) => {

  

  var sqlQuery=`select categoryId,name,profit,vat,customDuty from category where removedDate is  null ;`
