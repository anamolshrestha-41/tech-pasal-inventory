...
export default function UpdateMyOrderFormDialog(props) {
  const {
    myOrderToUpdateId,
    updateMyOrder,
  ...
  const handleDataChange = (e) => {
    ...
    setNewMyOrderData({ ...newMyOrderData, [e.target.name]: e.target.value });
  };
  ...
  const updateOrderConfirm = () => {
    updateMyOrder(myOrderToUpdateId, newMyOrderData);
    handleClose();
  };
      ...
      >
        ...
        <DialogContent>
          ...
          <FormControl
            ...
            variant="standard"
          >
            <InputLabel htmlFor="standard-adornment-name">Quantity</InputLabel>
            <Input
              required
              type="number"
              inputProps={{
